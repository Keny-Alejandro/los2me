...
$Consulta = "SELECT objeto.foto, objeto.nombre, objeto.id_objeto, objeto.fecha, usuario.nick, usuario.civica, estado.descripcion FROM objeto INNER JOIN usuario ON objeto.civica=usuario.civica INNER JOIN estado ON objeto.estado=estado.id_estado WHERE objeto.id_objeto='".$code."'";
...
$Filas = mysqli_num_rows($Resultado);
    ...
    if($Filas!=0){
     ...
     if($Resultado){
        ...
        ?>
        <form action="ActualizarRep.php" class="formulario3" method="post" style="text-align: center">
